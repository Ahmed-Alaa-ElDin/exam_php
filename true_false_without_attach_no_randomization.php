...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading true_false">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="form-group">
                                                    <div class='totalChoices radio-list'>
    ...
    <script src="ahmed_student/script/test/true_false(without attach-no randomization).js" type="text/javascript"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
