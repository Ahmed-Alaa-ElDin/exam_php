...
<head>
    ...
    <link rel="stylesheet" href="ahmed_teacher_review/style/jkanban.min.css">
    <!-- end:: jkanban's style -->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading assortment">
    ...
    <script src="ahmed_teacher_review/script/assortment.js" type="text/javascript"></script>
    <!-- begin:: jkanban -->
    <script src="ahmed_teacher_review/script/jkanban.js" type="text/javascript"></script>
    <!-- end:: jkanban -->
