...
var myurl = '';
myurl = 'assets/custom/json/student.json';

alert(myurl);
$('#SearchForm').click(function(){
   
    $('#kt_datatable').KTDatatable().destroy();
     myurl = 'assets/custom/json/studentSearch.json';
            ...
            columns: [
                    ...
                    template: function (data) {
                        ...
                        if (number > 8) {
                            output = '<div class="d-flex align-items-center">\
								...
								<div class="ml-2">\
									<div class="text-dark-75 font-weight-bold line-height-sm">' + data.StudentName + '</div>\
                            ...
                            output = '<div class="d-flex align-items-center">\
								<div class="symbol symbol-40 symbol-' + state + ' flex-shrink-0">\
									<div class="symbol-label text-uppercase">' + data.StudentName.substring(0, 1) + '</div>\
								</div>\
								<div class="ml-2">\
									<div class="text-dark-75 font-weight-bold line-height-sm">' + data.StudentName + '</div>\
									<a href="#" class="font-size-sm text-dark-50 text-hover-primary">' +
                ...
                },
                {
                    ...
                    template: function (row) {
                        ...
                        return '<span class="label font-weight-bold' + status[row.Status].class + ' label-inline">' + status[row.Status].title + '</span>';
                    },
                },
                {
                    field: 'Actions',
    ...
    var ViewAllStudentFilters = function () {
        ...
        $('#StudentClass, #kt_select2_1_validate').select2({
         ...
         $('#AcademicYear, #kt_select2_1_validate').select2({
            placeholder: 'Select Student Academic Year'
        });
    };
