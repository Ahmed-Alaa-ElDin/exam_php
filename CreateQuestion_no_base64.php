...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                                                ...
                                                                <tr data-repeater-item="" class="choice">
                                                                    ...
                                                                    <td class="multi-choice-td">
                                                                        <div class="inputKeyboard">
                                                                            <input type="text" class="form-control choice-text keyboard choiceInput" placeholder="Enter Possible Choice" >
                                                                        </div>
                                                                    </td>
    ...
    <div class="keyboardDiv">
        ...
        <img src="ahmed/img/keyboardUrdu.png" alt="keyboardUrdu" class="keyboardUrdu">
        <img src="ahmed/img/keyboardArabic.png" alt="keyboardArabic" class="keyboardArabic">
    </div>
    <!--end::Global Config-->
    ...
    <!-- <script src="ahmed/script/jquery.keyboard/ajax/libs/jqueryui/1.12.0/jquery-ui.min.js"></script> -->
    ...
    <!-- begin:: arabicEditor -->
    <script src="ahmed/script/arabictextbox.js" type="text/javascript"></script>
    <!-- end:: arabicEditor -->

    <!-- begin:: Ahmed's Script -->
    <script src="ahmed/script/script_no_base64.js" type="text/javascript"></script>
    <!-- end:: Ahmed's Script -->
