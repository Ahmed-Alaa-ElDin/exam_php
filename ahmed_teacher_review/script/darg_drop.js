$(function() {
    ...
    // JSON input  
    var json_input = { "academic_id": "1", "academic_year": "2020 - 2021", "grade_id": "", "grade_name": "", "subject_id": "", "subject_name": "", "topic_name": "", "filter_tags": [], "question_html": "وصل الحاجات ببعضها", "question_details": "<p>Try to match similar items together</p>", "rondomize_options": true, "allow_attachment": true, "allow_partial_credit": true, "maximum_marks": "20", "maximum_time": "1", "display_type": "line", "question_images": {}, "pairs": [{ "question_image_name": "ball.png", "question_image": "ahmed_teacher_review/img/ball.png", "question_text": "Ball", "answer_text": "كرة" }, { "question_text": "قطة", "answer_image_name": "cat.png", "answer_image": "ahmed_teacher_review/img/cat.png", "answer_text": "Cat" }, { "question_image_name": "frog.png", "question_image": "", "answer_text": "Frog" }, { "question_text": "شنطة", "answer_text": "Bag" }] }
    ...
    // var json_input = { "pairs": { "pairs": [{ "question_image_name": "ball.png", "question_image": "ahmed_teacher_review/img/ball.png", "question_text": "Ball", "answer_image_name": "cat.png", "answer_image": "ahmed_teacher_review/img/cat.png", "answer_text": "Cat" }, { "question_image": "", "question_text": "قطة", "answer_image_name": "frog.png", "answer_image": "ahmed_teacher_review/img/frog.png", "answer_text": "Frog" }, { "question_image_name": "frog.png", "question_image": "ahmed_teacher_review/img/frog.png", "question_text": "ضفدع", "answer_image": "", "answer_text": "Bag" }, { "question_image": "", "question_text": "شنطة", "answer_image": "", "answer_text": "" }] }, "screenshot": "canvas.toDataURL()" }
    ...
    //     if (element["question_image_name"] != undefined && element["question_text"] != "") {
    ...
    //     } else if (element["question_image_name"] != undefined) {
    ...
    //     }
    //     num += 1
    //     if (element["answer_image_name"] != undefined && element["answer_text"] != "") {
    ...
    //     } else if (element["answer_image_name"] != undefined) {
    ...
    //     }
    //     connect($("#question" + (num - 1) + ""), $("#answer" + num + ""), randomColor);
    //     $("#question" + (num - 1) + "").css("border-color", randomColor)
    //     $("#answer" + num + "").css("border-color", randomColor)
    //     num += 1
    // })
