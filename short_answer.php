...
<html lang="en" >
    ...
    <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        ...
                                                        <h1 class="text-danger">***** DEVELOPER NOTES ****** if teacher has turn off rich text area we will display normal text area</h1>
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                ...
                                                <div class="col text-right">
                                                    ...
                                                    <button type="reset" class="btn btn-danger">Submit & Next</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="ahmed_student/script/script.js" type="text/javascript"></script>
        <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
</html>